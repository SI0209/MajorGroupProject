<%@ Page Title="Services" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Services.aspx.cs" Inherits="DrivingSchoolWebsite.Public_Pages.Services" %>
    ...
    <section class="services-section">
        ...
        <div class="service-icons">
            ...
            <div class="service-block">
                <asp:Image runat="server" ImageUrl="~/Images/code8Icon.png" AlternateText="Code 8 Icon" CssClass="vehicle-image" />
            ...
            <div class="service-block">
                <asp:Image runat="server" ImageUrl="~/Images/Code10Icon.png" AlternateText="Code 10 Icon" CssClass="vehicle-image" />
